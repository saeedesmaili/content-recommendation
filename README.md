...
1. Extract text content from saved articles in Pocket or similar services
2. Generate embeddings for each piece of liked content
3. Store these embeddings for comparison with new content
